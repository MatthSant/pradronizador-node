  ...
  return (
    <nav className="!fixed top-0 left-4 right-4 z-50 py-4 flex justify-between items-center glass-card mt-4 px-8 border-black/[0.1]">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="p-2.5 hover:bg-black/5 rounded-xl transition-all border border-transparent hover:border-black/5 group focus:ring-2 focus:ring-purple-600 outline-none">
          <Settings className="w-4 h-4 text-slate-600 group-hover:rotate-45 transition-transform" />
        </button>
      </div>
    </nav>
  );
